...
Основні моделі є 1-5. 
Моделі ідентичні за структурою і параметрами.
Також була спроба змінити деякі гіперпараметри у версіях моделей а, b, c. Для моделей a, b, c застосованно акселератор GPU T4, для нормальної роботи з акселератором було застосовано batch-size 512, що можливо і наклало деякі умови що не дають адекватно порівнювати моделі.
